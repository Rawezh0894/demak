                        ...
                        <div class="project-card-modern" 
                            ...
                            <div class="project-card-content">
                                ...
                                <div class="project-card-meta">
                                    ...
                                    <?php if ($projectArea && $projectArea !== '-'): ?>
                                    <div class="project-meta-item">
                                        <i class="fas fa-ruler-combined"></i>
                                        <span><?php echo htmlspecialchars($projectArea, ENT_QUOTES, 'UTF-8'); ?> م²</span>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($projectFloors && $projectFloors !== '-'): ?>
                                    <div class="project-meta-item">
                                        <i class="fas fa-layer-group"></i>
                                        <span><?php echo htmlspecialchars($projectFloors, ENT_QUOTES, 'UTF-8'); ?></span>
                                    </div>
                                    <?php endif; ?>
                                </div>
