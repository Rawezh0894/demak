        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="order-2 lg:order-1 <?php echo $flex_direction; ?>">
                <div class="relative group">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-cyan-400/20 rounded-3xl blur-3xl transform group-hover:scale-110 transition-transform duration-500"></div>
                    
                    <!-- Main Image Container -->
                    <div class="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden transform group-hover:scale-[1.02] transition-all duration-500">
                        <div class="aspect-[4/3] bg-gradient-to-br from-amber-50 via-stone-100 to-amber-50 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 flex items-center justify-center">
                    ...
                    <!-- Floating Elements -->
                    <div class="absolute -top-4 -right-4 w-24 h-24 bg-blue-500/10 rounded-full blur-xl animate-pulse"></div>
                    <div class="absolute -bottom-4 -left-4 w-32 h-32 bg-cyan-500/10 rounded-full blur-xl animate-pulse delay-300"></div>
                </div>
            </div>
