<?php
// Include the main exterior design management logic
require_once '../../process/exterior_design/exterior_design.php';
?>
...
<head>
    ...
    <title>بەڕێوەبردنی دیزاینی دەرەوە - <?php echo t('admin_panel'); ?></title>
...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="top-toolbar">
        <button onclick="toggleDarkMode()" class="toolbar-btn">
            ...
            <i id="darkModeIcon" class="fas fa-moon text-green-500 hidden"></i>
            <span class="text-sm text-gray-700 dark:text-gray-200"><?php echo t('theme'); ?></span>
        </button>
        <a href="admin_panel.php" class="toolbar-btn text-green-600 dark:text-green-400 border-green-200">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8 text-center">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
                    <div class="flex flex-col items-center">
                        <div class="w-20 h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mb-6">
                            <i class="fas fa-tree text-white text-3xl"></i>
                        </div>
                        <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                            بەڕێوەبردنی دیزاینی دەرەوە
                        </h1>
                        <p class="text-xl text-gray-600 dark:text-gray-400 mb-6">
                            بەڕێوەبردنی پڕۆژەکانی دیزاینی دەرەوەی بینا
                        </p>
                        <button onclick="openAddProjectModal()" 
                                class="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl font-medium transition-all duration-200 flex items-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <input type="text" 
                                   id="searchInput"
                                   class="w-full pl-12 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-lg"
                    ...
                    <div>
                        ...
                        <select id="sortSelect"
                                class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-lg">
            ...
            <div class="mb-8">
                ...
                <?php if (!empty($exterior_design_projects)): ?>
                    <?php foreach ($exterior_design_projects as $project): ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="project_description" 
                                          ...
                                          rows="4"
                                          required
                                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"></textarea>
                            </div>
                                ...
                                <div class="upload-dropzone relative p-6 text-center">
                                    <div class="flex flex-col items-center justify-center space-y-2">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-300">
                                            وێنە دەخەیت یان کلیک لەسەر بکە بۆ بارکردن
                                        </p>
                            ...
                            <div>
                                ...
                                <div class="upload-dropzone relative p-6 text-center">
                                    <div class="flex flex-col items-center justify-center space-y-2">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-300">
                                            وێنەی زۆر دەخەیت یان کلیک لەسەر بکە بۆ بارکردن
                                        </p>
    ...
    <script src="../../assets/js/admin/exterior_design/exterior_design.js"></script>
