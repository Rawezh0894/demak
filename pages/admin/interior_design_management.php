<?php
// Include the main interior design management logic
require_once '../../process/interior_design/interior_design.php';
?>
...
<head>
    ...
    <title>بەڕێوەبردنی دیزاینی ناوەوە - <?php echo t('admin_panel'); ?></title>
...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
                    <div class="flex flex-col items-center">
                        ...
                        <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                            بەڕێوەبردنی دیزاینی ناوەوە
                        </h1>
                        <p class="text-xl text-gray-600 dark:text-gray-400 mb-6">
                            بەڕێوەبردنی پڕۆژەکانی دیزاینی ناوەوەی بینا
                        </p>
            ...
            <div class="mb-8">
                ...
                <?php if (!empty($interior_design_projects)): ?>
                    <?php foreach ($interior_design_projects as $project): ?>
    ...
    <script src="../../assets/js/admin/interior_design/interior_design.js"></script>
