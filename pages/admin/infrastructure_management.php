<?php
// Include the main infrastructure management logic
require_once '../../process/infrastructure_management/infrastructure_management.php';
?>
...
<head>
    ...
    <title><?php echo t('infrastructure_management'); ?> - <?php echo t('admin_panel'); ?></title>
...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <div id="mainContent" class="main-content-without-navbar">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8 text-center">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
                    <div class="flex flex-col items-center">
                        <div class="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6">
                            <i class="fas fa-building text-white text-3xl"></i>
                        </div>
                        <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                            <?php echo t('infrastructure_management'); ?>
                        </h1>
                        <p class="text-xl text-gray-600 dark:text-gray-400 mb-6">
                            <?php echo t('manage_infrastructure'); ?>
                        </p>
            ...
            <div class="mb-8">
                ...
                <?php if (!empty($infrastructure_projects)): ?>
                    <?php foreach ($infrastructure_projects as $project): ?>
                ...
                <div id="paginationContainer" class="mt-8">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            if ($startPage > 1): ?>
                                <button onclick="updateProjectsList(1)" class="pagination-number">1</button>
                                <?php if ($startPage > 2): ?>
                            ...
                            <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                                ...
                                <button class="pagination-number pagination-number-active"><?php echo $i; ?></button>
                                <?php else: ?>
                                <button onclick="updateProjectsList(<?php echo $i; ?>)" 
                                        class="pagination-number"><?php echo $i; ?></button>
                                <?php endif; ?>
                            <?php endfor; ?>
                            ...
                            <?php if ($endPage < $total_pages): ?>
                                ...
                                <button onclick="updateProjectsList(<?php echo $total_pages; ?>)" 
                                        class="pagination-number"><?php echo $total_pages; ?></button>
                            <?php endif; ?>
    ...
    <script src="../../assets/js/admin/infrastructure_management/infrastructure_management.js"></script>
    <script src="../../assets/js/admin/infrastructure_management/modal.js"></script>
    <script src="../../assets/js/admin/infrastructure_management/features.js"></script>
    <script src="../../assets/js/admin/infrastructure_management/image-preview.js"></script>
    <script src="../../assets/js/admin/infrastructure_management/add.js"></script>
    <script src="../../assets/js/admin/infrastructure_management/edit.js"></script>
    <script src="../../assets/js/admin/infrastructure_management/delete.js"></script>
    <script src="../../assets/js/admin/infrastructure_management/select.js"></script>
    <script src="../../assets/js/admin/infrastructure_management/update.js"></script>
