    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if (!$recent_action_found) {
            ...
            try {
                ...
                switch ($_POST['action']) {
                    case 'add_project':
                        require_once '../../process/infrastructure_management/add.php';
                        break;
                    case 'edit_project':
                        require_once '../../process/infrastructure_management/update.php';
                        break;
                    case 'delete_project':
                        require_once '../../process/infrastructure_management/delete.php';
                        break;
                    default:
...
// Load data
require_once '../../process/infrastructure_management/select.php';
?>
