<?php
// Add Interior Design Project Functionality
...
try {
    ...
    $stmt = $pdo->prepare("
        INSERT INTO interior_design_projects 
    ...
    if (function_exists('createDetailedNotification')) {
        createDetailedNotification($pdo, $_SESSION['admin_id'], 'create', 'interior_design_projects', $project_id, 'New interior design project created', null, null, ['project_name' => $project_name], getUserIP());
    }
