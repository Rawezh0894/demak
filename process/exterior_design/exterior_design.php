    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if (!$recent_action_found) {
            ...
            try {
                switch ($_POST['action']) {
                    case 'add_project':
                        require_once '../../process/exterior_design/add.php';
                        break;
                    case 'edit_project':
                        require_once '../../process/exterior_design/update.php';
                        break;
                    case 'delete_project':
                        require_once '../../process/exterior_design/delete.php';
                        break;
                    default:
...
// Load data
require_once '../../process/exterior_design/select.php';
?>
