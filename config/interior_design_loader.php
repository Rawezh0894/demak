<?php
/**
 * Interior Design Data Loader
 * Loads interior design projects from database
 */

function loadInteriorDesignData($pdo) {
    $projects = [];
    ...
    try {
        ...
        error_log("Error loading interior design projects: " . $e->getMessage());
        return [];
    }
}
?>
