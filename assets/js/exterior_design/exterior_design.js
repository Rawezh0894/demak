// Exterior Design Page JavaScript

// Project data from PHP (will be set by exterior-design.php)
let projectsData = {};
...
function setProjectsData(data) {
    console.log('Setting exterior design projects data:', data);
    projectsData = data;
    
    // Initialize sliders if not already initialized
    if (!slidersInitialized) {
        console.log('Initializing exterior design sliders from setProjectsData...');
        initializeSliders();
        initializeBackToTop();
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Exterior Design JS: DOM Content Loaded');
