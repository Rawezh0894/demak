...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2025 at 06:55 AM
...
--
-- Table structure for table `exterior_design_images`
--

CREATE TABLE `exterior_design_images` (
  `id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
  `image_path` varchar(500) NOT NULL,
  `is_main` tinyint(1) DEFAULT 0,
...
--
-- Dumping data for table `exterior_design_images`
--

INSERT INTO `exterior_design_images` (`id`, `project_id`, `image_path`, `is_main`, `sort_order`, `created_at`) VALUES
(1, 1, 'assets/images/projects/exterior_design/gallery/gallery_1762113076_0_3906.jpg', 0, 1, '2025-11-02 19:51:16'),
(2, 1, 'assets/images/projects/exterior_design/gallery/gallery_1762113076_1_9076.jpg', 0, 2, '2025-11-02 19:51:16'),
(3, 1, 'assets/images/projects/exterior_design/gallery/gallery_1762113076_2_6422.png', 0, 3, '2025-11-02 19:51:16');

-- --------------------------------------------------------

--
-- Table structure for table `exterior_design_projects`
--

CREATE TABLE `exterior_design_projects` (
  `id` int(11) NOT NULL,
  `name` varchar(200) NOT NULL,
  `name_ku` varchar(200) DEFAULT NULL,
  `name_ar` varchar(200) DEFAULT NULL,
...
--
-- Dumping data for table `exterior_design_projects`
--

INSERT INTO `exterior_design_projects` (`id`, `name`, `name_ku`, `name_ar`, `description`, `description_ku`, `description_ar`, `price`, `duration`, `main_image`, `status`, `sort_order`, `is_active`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'گوندی ئەڵمانی', 'گوندی ئەڵمانی', 'گوندی ئەڵمانی', 'هەولێرر', 'هەولێرر', 'هەولێرر', '500', '14', 'assets/images/projects/exterior_design/main_1762113076_8975.jpg', 'active', 0, 1, 1, '2025-11-02 19:51:16', '2025-11-02 19:51:53');
...
--
-- Table structure for table `interior_design_images`
--

CREATE TABLE `interior_design_images` (
  `id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
  `image_path` varchar(500) NOT NULL,
  `is_main` tinyint(1) DEFAULT 0,
...
--
-- Dumping data for table `interior_design_images`
--

INSERT INTO `interior_design_images` (`id`, `project_id`, `image_path`, `is_main`, `sort_order`, `created_at`) VALUES
(1, 1, 'assets/images/projects/interior_design/gallery/gallery_1762113670_0_3753.jpg', 0, 1, '2025-11-02 20:01:10'),
(2, 1, 'assets/images/projects/interior_design/gallery/gallery_1762113670_1_6975.jpg', 0, 2, '2025-11-02 20:01:10'),
(3, 1, 'assets/images/projects/interior_design/gallery/gallery_1762113670_2_4178.png', 0, 3, '2025-11-02 20:01:10');

-- --------------------------------------------------------

--
-- Table structure for table `interior_design_projects`
--
...
--
-- Dumping data for table `interior_design_projects`
--

INSERT INTO `interior_design_projects` (`id`, `name`, `name_ku`, `name_ar`, `description`, `description_ku`, `description_ar`, `price`, `duration`, `main_image`, `status`, `sort_order`, `is_active`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'گوندی ئەڵمانی', 'گوندی ئەڵمانی', 'گوندی ئەڵمانی', 'e', 'e', 'e', '500', '14', 'assets/images/projects/interior_design/main_1762113670_1408.jpg', 'active', 0, 1, 1, '2025-11-02 20:01:10', '2025-11-02 20:01:30');
...
(37, 1, 'create', 'exterior_design_projects', 1, 'New exterior design project created', NULL, NULL, '{\"project_name\":\"گوندی ئەڵمانی\"}', '::1', 0, '2025-11-02 19:51:16'),
(38, 1, 'update', 'exterior_design_projects', 1, 'Exterior design project updated', NULL, NULL, '{\"project_name\":\"گوندی ئەڵمانی\"}', '::1', 0, '2025-11-02 19:51:53'),
(39, 1, 'create', 'interior_design_projects', 1, 'New interior design project created', NULL, NULL, '{\"project_name\":\"گوندی ئەڵمانی\"}', '::1', 0, '2025-11-02 20:01:10'),
(40, 1, 'update', 'interior_design_projects', 1, 'Interior design project updated', NULL, NULL, '{\"project_name\":\"گوندی ئەڵمانی\"}', '::1', 0, '2025-11-02 20:01:30');
...
--
-- Indexes for table `exterior_design_images`
--
ALTER TABLE `exterior_design_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_project` (`project_id`),
  ADD KEY `idx_main` (`is_main`),
  ADD KEY `idx_sort` (`sort_order`);
...
--
-- Indexes for table `exterior_design_projects`
--
ALTER TABLE `exterior_design_projects`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `idx_active` (`is_active`),
  ADD KEY `idx_created_by` (`created_by`),
...
--
-- Indexes for table `interior_design_images`
--
ALTER TABLE `interior_design_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_project` (`project_id`),
  ADD KEY `idx_main` (`is_main`),
  ADD KEY `idx_sort` (`sort_order`);
...
--
-- Indexes for table `interior_design_projects`
--
ALTER TABLE `interior_design_projects`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `idx_active` (`is_active`),
  ADD KEY `idx_created_by` (`created_by`),
...
--
-- AUTO_INCREMENT for table `exterior_design_images`
--
ALTER TABLE `exterior_design_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `exterior_design_projects`
--
ALTER TABLE `exterior_design_projects`
...
--
-- AUTO_INCREMENT for table `interior_design_images`
--
ALTER TABLE `interior_design_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `interior_design_projects`
--
ALTER TABLE `interior_design_projects`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `exterior_design_images`
--
ALTER TABLE `exterior_design_images`
  ADD CONSTRAINT `exterior_design_images_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `exterior_design_projects` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `exterior_design_projects`
--
ALTER TABLE `exterior_design_projects`
  ADD CONSTRAINT `exterior_design_projects_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL;
...
--
-- Constraints for table `interior_design_images`
--
ALTER TABLE `interior_design_images`
  ADD CONSTRAINT `interior_design_images_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `interior_design_projects` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `interior_design_projects`
--
ALTER TABLE `interior_design_projects`
  ADD CONSTRAINT `interior_design_projects_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL;
